...
imposto_075 = 33919.80 - 22847.76
imposto_15 = 45012.60 - 33919.80
...
if (login == "ana" and senha == "12345") or (login == "joao" and senha == "54321"):
    ...
    # válido para imposotos abaixo de 45012.60
    ...
    # imposto=0
      if renda_anual <= 22847.76:  #abaixo de 22847.76
          imposto = 0
          
      elif renda_anual <= 33919.80:  #abaixo de 33919.80
          imposto_22 = renda_anual - 22847.76
          imposto_real = imposto_22 * 0.075

      elif renda_anual <= 45012.60:  #abaixo de 45012.60
          imposto_33 = renda_anual - 33919.80
          imposto_real = (imposto_075 * 0.075) + (imposto_33 * 0.15)

      elif renda_anual <= 55976.16:  #abaixo de 55976.16
          imposto_45 = renda_anual - 45012.60
          imposto_real = (imposto_075 * 0.075) + (imposto_15 * 0.15) + (imposto_45 * 0.225)

      else:
          imposto_55 = renda_anual - 55976.16  #acima de 55976.16
          imposto_45 = 55976.16 - 45012.60
          
          imposto_real = (imposto_075 * 0.075) + (imposto_15 * 0.15) + (imposto_45 * 0.225) + (imposto_55 * 0.275)
